...
class _settings extends \IPS\Dispatcher\Controller
{
	...
	protected function getForm()
	{
        ...
        $form->add(new \IPS\Helpers\Form\Text('rust_ip', \IPS\Settings::i()->rust_ip, false, array(), null,
            null, null, 'rust_ip'));
        $form->add(new \IPS\Helpers\Form\Text('rust_port', \IPS\Settings::i()->rust_port, false, array(), null,
            null, null, 'rust_port'));
		...
		$form->add(new \IPS\Helpers\Form\Text('rust_product_1_comamnd', \IPS\Settings::i()->rust_product_1_comamnd, false, array(), null,
            null, null, 'rust_product_1_comamnd'));
		...
		$form->add(new \IPS\Helpers\Form\Text('rust_product_2_comamnd', \IPS\Settings::i()->rust_product_2_comamnd, false, array(), null,
            null, null, 'rust_product_2_comamnd'));
		...
		$form->add(new \IPS\Helpers\Form\Text('rust_product_3_comamnd', \IPS\Settings::i()->rust_product_3_comamnd, false, array(), null,
            null, null, 'rust_product_3_comamnd'));
		$form->add(new \IPS\Helpers\Form\Text('rust_product_3_arguments', \IPS\Settings::i()->rust_product_3_arguments, false, array(), null,
		...
		$form->add(new \IPS\Helpers\Form\Text('rust_product_4_comamnd', \IPS\Settings::i()->rust_product_4_comamnd, false, array(), null,
            null, null, 'rust_product_4_comamnd'));
